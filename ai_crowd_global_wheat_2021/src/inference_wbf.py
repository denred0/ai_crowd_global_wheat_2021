...
def main():
    ...
    for i, file in tqdm(enumerate(test_files)):
        ...
        # if file.stem == '1aeba2df1a75fc2c195295d0868eb8c2bf2a3495c0061e18d7fdfe82f734de82':
            ...
            boxes_wbf, scores, labels = weighted_boxes_fusion([boxes_new], [confidences], [classIDs], weights=None,
            ...
            cv2.imwrite('data/inference_result_wbf/' + str(file.stem) + '.png', image)
